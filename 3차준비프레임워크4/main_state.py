...
def Create_Object1(Type):
    ...
    Object_Data_File = open('object_data1.txt', 'r')
    Object_Data = json.load( Object_Data_File )
    if Type == BALANCE1:
        Object = Balance_Enemy()
